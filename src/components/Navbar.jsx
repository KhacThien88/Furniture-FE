...
const Navbar = () => {
  ...
  const handleSearchClick = () => {
    if (location.pathname === '/shop') {
      // Nếu đã ở trang shop set the state mà không cần navigation
      navigate(location.pathname, { state: { showSearchBar: true } });
    } else {
      navigate('/shop', { state: { showSearchBar: true } });
    }
  };
